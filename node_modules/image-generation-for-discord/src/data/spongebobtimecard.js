...
async function spongebobtimecard(text) {
    ...
    const base = await loadImage(
        path.join(__dirname, '..', 'assets', 'spongebob-time-card', `${num}.png`)
    );
    ctx.drawImage(base, 0, 0);
    ctx.textAlign = 'center';
    ctx.textBaseline = 'top';
    ctx.font = '115px Spongeboytt1';
    const lines = await canvasClass.wrapText(ctx, text.toUpperCase(), 1800);
...
module.exports = spongebobtimecard